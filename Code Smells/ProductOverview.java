...
public class ProductOverview implements IProductObserver {
    private Scanner scanner = new Scanner(System.in);

    public ProductOverview(ProductInventoryObservable subject) {
    ...
    private void showProductDetails(IProduct product) {
        ...
        System.out.println("RentPrice: " + product.createPriceCalculator().calculateRentPrice());
        System.out.println("Insurance: " + product.createPriceCalculator().calculateRentPrice());
        System.out.println("Total Price: " + product.createPriceCalculator().calculatePrice());
        if (product.isRented()){
    ...
    public void inventoryUpdate() {
        System.out.println("Product inventory has been updated. Refreshing the product overview");
    }
}
